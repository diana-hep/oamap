...
class TestPython(unittest.TestCase):
    ...
    def test_toarrays(self):
        ...
        same(toarrays("prefix", [1, [3.14, False], 2], List(Union(List(Union(boolean, float64)), int64))), {"prefix-Lo": numpy.array([3], dtype=numpy.uint64), "prefix-Ld-Ut": numpy.array([0, 1, 0], dtype=numpy.uint64), "prefix-Ld-Uo": numpy.array([0, 0, 1], dtype=numpy.uint64), "prefix-Ld-Ud0": numpy.array([1, 2]), "prefix-Ld-Ud1-Lo": numpy.array([2], dtype=numpy.uint64), "prefix-Ld-Ud1-Ld-Ut": numpy.array([1, 0], dtype=numpy.uint64), "prefix-Ld-Ud1-Ld-Uo": numpy.array([0, 0], dtype=numpy.uint64), "prefix-Ld-Ud1-Ld-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-Ld-Ud1-Ld-Ud1": numpy.array([3.14])})
        ...
        same(toarrays("prefix", {"one": 99, "two": 3.14}, Record(one=int64, two=Union(boolean, float64))), {"prefix-R_one": numpy.array([99]), "prefix-R_two-Ut": numpy.array([1], dtype=numpy.uint64), "prefix-R_two-Uo": numpy.array([0], dtype=numpy.uint64), "prefix-R_two-Ud0": numpy.array([], dtype=numpy.bool), "prefix-R_two-Ud1": numpy.array([3.14])})
        same(toarrays("prefix", {"one": 99, "two": False}, Record(one=int64, two=Union(boolean, float64))), {"prefix-R_one": numpy.array([99]), "prefix-R_two-Ut": numpy.array([0], dtype=numpy.uint64), "prefix-R_two-Uo": numpy.array([0], dtype=numpy.uint64), "prefix-R_two-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-R_two-Ud1": numpy.array([])})

        same(toarrays("prefix", [{"one": 98, "two": 3.14}, {"one": 99, "two": False}], List(Record(one=int64, two=Union(boolean, float64)))), {"prefix-Lo": numpy.array([2], dtype=numpy.uint64), "prefix-Ld-R_one": numpy.array([98, 99]), "prefix-Ld-R_two-Ut": numpy.array([1, 0], dtype=numpy.uint64), "prefix-Ld-R_two-Uo": numpy.array([0, 0], dtype=numpy.uint64), "prefix-Ld-R_two-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-Ld-R_two-Ud1": numpy.array([3.14])})
