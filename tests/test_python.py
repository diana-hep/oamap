...
class TestPython(unittest.TestCase):
    ...
    def test_toarrays(self):
        ...
        # L
        same(toarrays("prefix", [False, True], List(boolean)), {"prefix-Lo": numpy.array([0, 2], dtype=numpy.int64), "prefix-Ld": numpy.array([False, True])})
        same(toarrays("prefix", [1, 2, 3], List(int64)), {"prefix-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-Ld": numpy.array([1, 2, 3])})
        same(toarrays("prefix", [1, 2, 3], List(float64)), {"prefix-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-Ld": numpy.array([1.0, 2.0, 3.0])})

        same(toarrays("prefix", [[1], [2, 3], []], List(List(int64))), {"prefix-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-Ld-Lo": numpy.array([0, 1, 3, 3], dtype=numpy.int64), "prefix-Ld-Ld": numpy.array([1, 2, 3])})
        same(toarrays("prefix", [[], [1], [2, 3]], List(List(int64))), {"prefix-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-Ld-Lo": numpy.array([0, 0, 1, 3], dtype=numpy.int64), "prefix-Ld-Ld": numpy.array([1, 2, 3])})

        # U
        same(toarrays("prefix", False, Union(boolean, int64)), {"prefix-Ut": numpy.array([0], dtype=numpy.uint8), "prefix-Uo": numpy.array([0], dtype=numpy.int64), "prefix-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-Ud1": numpy.array([], dtype=numpy.int64)})
        same(toarrays("prefix", 1, Union(boolean, int64)), {"prefix-Ut": numpy.array([1], dtype=numpy.uint8), "prefix-Uo": numpy.array([0], dtype=numpy.int64), "prefix-Ud0": numpy.array([], dtype=numpy.bool), "prefix-Ud1": numpy.array([1], dtype=numpy.int64)})

        same(toarrays("prefix", [False, 1], List(Union(boolean, int64))), {"prefix-Lo": numpy.array([0, 2], dtype=numpy.int64), "prefix-Ld-Ut": numpy.array([0, 1], dtype=numpy.uint8), "prefix-Ld-Uo": numpy.array([0, 0], dtype=numpy.int64), "prefix-Ld-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-Ld-Ud1": numpy.array([1])})
        same(toarrays("prefix", [1, False], List(Union(boolean, int64))), {"prefix-Lo": numpy.array([0, 2], dtype=numpy.int64), "prefix-Ld-Ut": numpy.array([1, 0], dtype=numpy.uint8), "prefix-Ld-Uo": numpy.array([0, 0], dtype=numpy.int64), "prefix-Ld-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-Ld-Ud1": numpy.array([1])})
        same(toarrays("prefix", [1, False, 2], List(Union(boolean, int64))), {"prefix-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-Ld-Ut": numpy.array([1, 0, 1], dtype=numpy.uint8), "prefix-Ld-Uo": numpy.array([0, 0, 1], dtype=numpy.int64), "prefix-Ld-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-Ld-Ud1": numpy.array([1, 2])})

        same(toarrays("prefix", [1, [3.14], 2], List(Union(List(float64), int64))), {"prefix-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-Ld-Ut": numpy.array([0, 1, 0], dtype=numpy.uint8), "prefix-Ld-Uo": numpy.array([0, 0, 1], dtype=numpy.int64), "prefix-Ld-Ud0": numpy.array([1, 2]), "prefix-Ld-Ud1-Lo": numpy.array([0, 1], dtype=numpy.int64), "prefix-Ld-Ud1-Ld": numpy.array([3.14])})

        same(toarrays("prefix", [1, [3.14, False], 2], List(Union(List(Union(boolean, float64)), int64))), {"prefix-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-Ld-Ut": numpy.array([0, 1, 0], dtype=numpy.uint8), "prefix-Ld-Uo": numpy.array([0, 0, 1], dtype=numpy.int64), "prefix-Ld-Ud0": numpy.array([1, 2]), "prefix-Ld-Ud1-Lo": numpy.array([0, 2], dtype=numpy.int64), "prefix-Ld-Ud1-Ld-Ut": numpy.array([1, 0], dtype=numpy.uint8), "prefix-Ld-Ud1-Ld-Uo": numpy.array([0, 0], dtype=numpy.int64), "prefix-Ld-Ud1-Ld-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-Ld-Ud1-Ld-Ud1": numpy.array([3.14])})
        ...
        same(toarrays("prefix", [{"one": 1, "two": 1.1}, {"one": 2, "two": 2.2}], List(Record(one=int64, two=float64))), {"prefix-Lo": numpy.array([0, 2], dtype=numpy.int64), "prefix-Ld-R_one": numpy.array([1, 2]), "prefix-Ld-R_two": numpy.array([1.1, 2.2])})

        same(toarrays("prefix", {"one": [1, 2, 3], "two": 3.14}, Record(one=List(int64), two=float64)), {"prefix-R_one-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-R_one-Ld": numpy.array([1, 2, 3]), "prefix-R_two": numpy.array([3.14])})

        same(toarrays("prefix", [{"one": [1, 2], "two": 1.1}, {"one": [], "two": 2.2}, {"one": [3], "two": 3.3}], List(Record(one=List(int64), two=float64))), {"prefix-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-Ld-R_one-Lo": numpy.array([0, 2, 2, 3], dtype=numpy.int64), "prefix-Ld-R_one-Ld": numpy.array([1, 2, 3]), "prefix-Ld-R_two": numpy.array([1.1, 2.2, 3.3])})

        same(toarrays("prefix", {"one": 99, "two": 3.14}, Record(one=int64, two=Union(boolean, float64))), {"prefix-R_one": numpy.array([99]), "prefix-R_two-Ut": numpy.array([1], dtype=numpy.uint8), "prefix-R_two-Uo": numpy.array([0], dtype=numpy.int64), "prefix-R_two-Ud0": numpy.array([], dtype=numpy.bool), "prefix-R_two-Ud1": numpy.array([3.14])})
        same(toarrays("prefix", {"one": 99, "two": False}, Record(one=int64, two=Union(boolean, float64))), {"prefix-R_one": numpy.array([99]), "prefix-R_two-Ut": numpy.array([0], dtype=numpy.uint8), "prefix-R_two-Uo": numpy.array([0], dtype=numpy.int64), "prefix-R_two-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-R_two-Ud1": numpy.array([])})

        same(toarrays("prefix", [{"one": 98, "two": 3.14}, {"one": 99, "two": False}], List(Record(one=int64, two=Union(boolean, float64)))), {"prefix-Lo": numpy.array([0, 2], dtype=numpy.int64), "prefix-Ld-R_one": numpy.array([98, 99]), "prefix-Ld-R_two-Ut": numpy.array([1, 0], dtype=numpy.uint8), "prefix-Ld-R_two-Uo": numpy.array([0, 0], dtype=numpy.int64), "prefix-Ld-R_two-Ud0": numpy.array([False], dtype=numpy.bool), "prefix-Ld-R_two-Ud1": numpy.array([3.14])})

        same(toarrays("prefix", [{"one": 99}, {"two": 3.14}], List(Union(Record(one=int64), Record(two=float64)))), {"prefix-Lo": numpy.array([0, 2], dtype=numpy.int64), "prefix-Ld-Ut": numpy.array([0, 1], dtype=numpy.uint8), "prefix-Ld-Uo": numpy.array([0, 0], dtype=numpy.int64), "prefix-Ld-Ud0-R_one": numpy.array([99]), "prefix-Ld-Ud1-R_two": numpy.array([3.14])})
        same(toarrays("prefix", [{"one": 98}, {"two": 3.14}, {"one": 99}], List(Union(Record(one=int64), Record(two=float64)))), {"prefix-Lo": numpy.array([0, 3], dtype=numpy.int64), "prefix-Ld-Ut": numpy.array([0, 1, 0], dtype=numpy.uint8), "prefix-Ld-Uo": numpy.array([0, 0, 1], dtype=numpy.int64), "prefix-Ld-Ud0-R_one": numpy.array([98, 99]), "prefix-Ld-Ud1-R_two": numpy.array([3.14])})

        same(toarrays("prefix", [{"one": 98}, {"one": 99, "two": 3.14}], List(Union(Record(one=int64), Record(one=int64, two=float64)))), {"prefix-Lo": numpy.array([0, 2], dtype=numpy.int64), "prefix-Ld-Ut": numpy.array([1, 0], dtype=numpy.uint8), "prefix-Ld-Uo": numpy.array([0, 0], dtype=numpy.int64), "prefix-Ld-Ud0-R_one": numpy.array([99]), "prefix-Ld-Ud0-R_two": numpy.array([3.14]), "prefix-Ld-Ud1-R_one": numpy.array([98])})
